...
$forum_head['responsive'] = '<link rel="stylesheet" media="only screen and (max-device-width: 480px)" href="/iphone.css?new" type="text/css" media="screen" />';
$forum_head['viewport'] = '<meta name="viewport" content="width=device-width,initial-scale=1,maximum-scale=1">';
